...
Desenvolvedor e consultor Python/JS

<a href="https://ferpection.com/" className="company-logo">![Ferpection](assets/ferpection.png)</a>

<a href="https://simplefractal.com/" className="company-logo">![Simple Fractal](assets/simple-fractal.png)</a>
...
- [middlewares](#4)
- [wsgi](#8)
- [context processors](#12)

---

### django_apistar

[django_apistar](https://github.com/lucianoratamero/django_apistar) é um projeto que visa juntar a autodocumentação e velocidade do [API Star](https://github.com/encode/apistar) com as ferramentas de teste, shell e admin do Django

---

### primeira abordagem: middlewares
...
<CodeSurfer
  title='django_apistar.wsgi'
  code={require("!raw-loader!./snippets/wsgi.py")}
  theme={vsDark}
  lang="python"
  showNumbers={false}
  steps={[
    { lines: [7, 11, 17], notes: "vê se a rota (url) está registrada como rota do django" },
    { lines: [12], notes: "se sim, responde chamando a app wsgi do django" },
    { lines: [14], notes: "se não, responde chamando a app wsgi do apistar" },
  ]}
/>
...
### outro ponto interessante: context processors

- no fim de uma requisição, antes da renderização dos templates
- permitem adicionar variáveis ao contexto
- são funções simples e puras
- acesso direto, dentro do html
